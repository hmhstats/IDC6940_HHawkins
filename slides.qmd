...
<div style="text-align: center; font-size: 3em; margin-top: 30vh;">Introduction</div>
...
::: {.column width="45%"}
<img src="image8.png" alt="Secondary Traumatic Stress Scale illustration" style="max-width: 100%; height: auto; margin-top: 0.5em;" />
...
<div style="text-align: center; font-size: 3em; margin-top: 30vh;">Methods</div>
...
<div style="font-size: 0.65em; max-width: 700px; line-height: 1.3;">

**Logistic function:**

$$
\pi = P(Y = 1 \mid X_1 = x_1, X_2 = x_2, \ldots, X_k = x_k) 
= \frac{1}{1 + e^{-(\beta_0 + \beta_1 x_1 + \beta_2 x_2 + \cdots + \beta_k x_k)}}
$$

- $\pi$: Probability that the event (e.g., teacher leaving) occurs  
- $Y$: Binary outcome variable (1 = event occurs, 0 = does not occur)  
- $X_1, X_2, \ldots, X_k$: Predictor variables (e.g., stress score, years of experience)  
- $x_1, x_2, \ldots, x_k$: Observed values of the predictor variables  
...
[@peng2002introduction] [@tranmer2008binary] [@harris2021primer] [@abdulqader2017applying]
...
- Classification accuracy [@peng2002introduction] [@abdulqader2017applying]
...
- **Predictors:** STSS total score and subscale scores for Intrusion, Avoidance, Arousal

- **Predicted Outcome:** Probability that a teacher plans to leave the profession
...
bullet_points <- grid::textGrob(
  label = paste0(
    ...
    "• Intrusion scores peak similarly but higher scores occur among those leaving.\n",
...
<ul>
  <li>Embed trauma-informed training in teacher preparation programs & professional development</li>
