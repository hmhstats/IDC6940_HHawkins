...
```{r, warning=FALSE, echo=TRUE}
shapiro.test(sts_data$stss_total_score[sts_data$leave_teaching == 0])  # Stay
shapiro.test(sts_data$stss_total_score[sts_data$leave_teaching == 1])  # Leave
...
ggplot(sts_data, aes(x = stss_total_score, fill = as.factor(leave_teaching))) +
  geom_density(alpha = 0.5) +
